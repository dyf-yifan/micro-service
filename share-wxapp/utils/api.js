// 后端接口基础路径
export const BASE_API_URL = 'https://dingyifan.utools.club';
//export const BASE_API_URL = 'http://localhost:8048';
...
//我的投稿
export const USER_CONTRIBUTION_URL = SHARE_URL + '/contributions';
//签到
export const SIGN_URL = USER_URL + '/signIn';
